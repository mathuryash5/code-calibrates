...
from pal.prompt import math_prompts, math_text_prompt
...
OUTPUT_PATH = f'eval_results/{args.dataset}_text_{args.model}_t_1_k_{args.majority_at}.jsonl'
...
with open(OUTPUT_PATH, 'a' if args.append else 'w') as f:
	...
	for x in pbar:
		...
		result = copy.copy(x)
		try:
			ans = itf.run(prompt=math_text_prompt.MATH_TEXT_PROMPT, question=question,

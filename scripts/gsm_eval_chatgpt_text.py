...
from pal.prompt import math_prompts_with_reasoning_chatgpt
...
OUTPUT_PATH = f'eval_results/{args.dataset}_chatgpt_text.jsonl'
...
itf = interface.TextChatCodeInterface(
    ...
    system_message=math_prompts_with_reasoning_chatgpt.MATH_CHAT_BETA_PROMPT,
)
...
with open(OUTPUT_PATH, 'a' if args.append else 'w') as f:
    ...
    for x in pbar:
        ...
        try:
            ans = itf.run(
                math_prompts_with_reasoning_chatgpt.MATH_CHAT_BETA_PROMPT.format(question=question),

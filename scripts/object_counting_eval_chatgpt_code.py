...
from pal.prompt import object_counting_prompt
...
itf = interface.ProgramChatInterface(
    ...
    system_message=object_counting_prompt.OBJECT_COUNTING_BETA_SYSTEM_MESSAGE,
)
...
with open(OUTPUT_PATH, 'a' if args.append else 'w') as f:
    ...
    for x in pbar:
        ...
        try:
            ans = itf.run(
                object_counting_prompt.OBJECT_COUNTING_PROMPT.format(question=question),

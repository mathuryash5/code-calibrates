...
COLORED_CHAT_BETA_SYSTEM_MESSAGE = 'You will write python program to solve  problems. You will only write code blocks.'

COLORED_CHAT_BETA_PROMPT = """
Let's use Python to solve problems. Here are three examples how to do it,
Q: On the nightstand, there is a red pencil, a purple mug, a burgundy keychain, a fuchsia teddy bear, a black plate, and a blue stress ball. What color is the stress ball?
